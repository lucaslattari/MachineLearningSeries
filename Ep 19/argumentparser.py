...
class ArgumentParser:
    ...
    def setBasicArguments(self):
        ...
        self.parser.add_argument('-deli', dest='delimiter', required=True, type=str, help="delimiter of each column of csv")
        self.parser.add_argument('-missing', dest='fill_missing_data_columns', required=False, type=str, help="use fill missing data? (if yes, enter column numbers separated by commas)")
        self.parser.add_argument('-one_hot', dest='one_hot_encoding_columns', required=False, type=str, help="use one hot encoding? (if yes, enter column numbers separated by commas)")
